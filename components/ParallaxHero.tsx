...
export default function ParallaxHero({ image }: { image: string }) {
    ...
    >
      ...
      <div className="relative mx-auto flex min-h-[inherit] max-w-6xl flex-col justify-center gap-7 px-4 py-28 sm:px-6 sm:py-36 lg:px-8 lg:py-44">
        ...
        >
          Staviame s istotou.
          <br />
          <span className="text-brand-blue">30 rokov</span> v praxi.
        </h1>
        ...
        >
          <RollButton
            href="/referencie"
            className="rounded-full bg-brand-blue px-7 py-3 text-sm font-semibold text-white shadow-lg shadow-brand-blue/30 hover:bg-brand-blue-dark"
            ghost="Pozrieť práce"
          >
            Pozrieť referencie
          </RollButton>
